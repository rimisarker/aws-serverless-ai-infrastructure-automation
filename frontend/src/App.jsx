        ...
        <div className="panel glass-card">
          ...
          <div className="form-row">
            <label htmlFor="student-level">
              Level
              <select id="student-level" value={level} onChange={(event) => setLevel(event.target.value)}>
            ...
            <label htmlFor="study-days">
              ...
              <input
                ...
                max="30"
                value={days}
                onChange={(event) => setDays(Number(event.target.value))} // FIXED: Hardcast string to number safely
              />
            </label>
          </div>
      ...
      <section className="bottom-grid">
        <div className="glass-card mini-panel">
          ...
          <input
            ...
            max="100"
            value={progressScore}
            onChange={(event) => setProgressScore(Number(event.target.value))}
          />
...
// Subcomponents left intact for fast execution and lightweight file mapping
